...
call s:HL('VertSplit', 'lcontrast', 'lcontrast', 'none')
...
" Gutter {{{
call s:HL('CursorLineNr', 'vhcontrast', 'lcontrast', 'none')
...
call s:HL('Statement', 'nred', 'none', 'bold')
call s:HL('Keyword', 'nmagenta', 'none', 'bold')
call s:HL('Conditional', 'nred', 'none', 'bold')
call s:HL('Operator', 'nyellow', 'none', 'bold')
call s:HL('Label', 'vhcontrast', 'none', 'bold')
call s:HL('Repeat', 'nmagenta', 'none', 'bold')

call s:HL('Identifier', 'none', 'none', 'none')
call s:HL('Function', 'none', 'none', 'none')

call s:HL('PreProc', 'nblue', 'none', 'none')
...
call s:HL('Type', 'nyellow', 'none', 'bold')
call s:HL('Typedef', 'vhcontrast', 'none', 'bold')
call s:HL('StorageClass', 'nyellow', 'none', 'bold')
...
call s:HL('helpHyperTextJump', 'vhcontrast', 'none', 'underline')
call s:HL('helpTag', 'vhcontrast', 'none', 'underline')
...
" Netrw {{{
call s:HL('netrwSymLink', 'lcontrast', 'none', 'none')
call s:HL('netrwDir', 'hcontrast', 'none', 'none')
call s:HL('netrwExe', 'vhcontrast', 'none', 'bold')
...
call s:HL('markdownUrl', 'vhcontrast', 'none', 'underline')
...
" Python {{{
call s:HL('pythonBuiltin', 'ncyan', 'none', 'none')
call s:HL('pythonBuiltinObj', 'hcontrast')
call s:HL('pythonBuiltinFunc', 'hcontrast')
call s:HL('pythonFunction', 'nmagenta', 'none', 'none')
...
call s:HL('pythonInclude', 'ngreen', 'none', 'bold')
